          ...
          <div className="grid items-center grid-cols-1 gap-12 lg:grid-cols-2">
            <div>
              <p className="text-base font-semibold tracking-wider text-green-700 uppercase">
                A BYTE against waste
              </p>
              <h1 className="mt-4 text-4xl font-bold text-black lg:mt-8 sm:text-6xl xl:text-7xl">
              Empower Your Pantry, Reduce Your Waste
              </h1>
              <p className="mt-4 text-base text-black lg:mt-8 sm:text-xl">
              Take control of your food inventory and make a difference with Ahaar. Minimize waste, save money, and join the fight against food waste with smart tracking and AI-driven insights
              </p>
